Page({
  ...
  formSubmit: function (e) {
    this.data.backC = e.detail.value['input-backC'];
    this.data.blue = e.detail.value['input-blue'];
    this.data.navi = e.detail.value['input-navi'];
    this.data.dPay = e.detail.value['input-dPay'];
    this.data.wPay = e.detail.value['input-wPay'];
    this.data.mPay = e.detail.value['input-mPay'];
    this.data.content = e.detail.value['input-content'];
    this.data.mode = this.data.model;
    this.data.check = e.detail.value['checkGroup'];
  ...
  saveDataToServer: function (imageOk) {
    ...
    const carList = db.collection('rentcar')
    db.collection('rentcar').add({
      data: {
        count: 1,
        liulan: 1,
        
        backC:that.data.backC,
        blue: that.data.blue,
        navi: that.data.blue,
        dPay: that.data.dPay,
        wPay: that.data.wPay,
